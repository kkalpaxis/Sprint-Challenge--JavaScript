...
const uni = [];
var includesUni = universities.includes("uni");
for (i = 0; i < universities.length; i++) {
  uni.push(universities[i][includesUni])
}
console.log(uni);
...
*/
let lowerPopulation = zooAnimals
.filter((animal) => {
...
*/
let populationTotal = zooAnimals
.reduce((total, animal) => {
